                ...
                <div class="box">
                    ...
                    <form action="customerRegisterBegin" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="passportSerial-login" name="passportSerial">
                        </div>
                        <div class="form-group">
                            <label for="passportNumber-login">Passport number</label>
                            <input type="text" class="form-control" id="passportNumber-login" name="passportNumber">
                        </div>
                        <div class="form-group">
