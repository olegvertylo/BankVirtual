    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9 clearfix" id="customer-order">
                ...
                <form action="setNumber" method="post">
                ...
                <form action="setStatus" method="post">
                    <div class="form-group">
                        <label for="name-login">Please set the status</label>
                        <select class="form-control" id="name-login" name="status">
                            <option>Opened</option>
                            <option>Closed</option>
                        </select>
                    </div>
                    <div class="text-right">
                        <button type="submit" class="btn btn-template-main"><i class="fa fa-user-md"></i> Set
                        </button>
                    </div>
                </form>
                <br>
